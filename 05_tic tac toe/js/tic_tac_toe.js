...
const msgtxt3 = '<p class="image"><img src ="img/penguins.jpg" width=61xp height=61px></p><p class="text animate__animated animate__lightSpeedInRight">Penguins Win!!</p>';
const msgtxt4 = '<p class="image"><img src ="img/whitebear.jpg" width=61xp height=61px></p><p class="text animate__animated animate__lightSpeedInLeft">WhiteBear Win!!</p>';
const msgtxt5 = '<p class="image"><img src ="img/penguins.jpg" width=61xp height=61px><img src ="img/whitebear.jpg" width=61xp height=61px></p><p class="text animate__bounceIn">Draw!!</p>';
